...
const sizeColorsDivsNodes = document.querySelectorAll('.box-container');
...
// this function will get frist box data and call boxShow
box1.addEventListener('click', () => {
    const radiobtn = radioButtonsNodes[0]; // return html node
    const sizeBoxController = sizeColorsDivsNodes[0]; // return html node
    // Passing 3 nodes as argument to boxShow
    boxShow(boxesChildNode, radiobtn, sizeBoxController, box1);

});
// this function will get second box data and call boxShow
box2.addEventListener('click', () => {
    const radiobtn = radioButtonsNodes[1]; // return html node
    const sizeBoxController = sizeColorsDivsNodes[1]; // return html node
    // Passing 3 nodes as argument to boxShow
    boxShow(boxesChildNode, radiobtn, sizeBoxController, box2);
});
// this function will get third box data and call boxShow
box3.addEventListener('click', () => {
    const radiobtn = radioButtonsNodes[2]; // return html node
    const sizeBoxController = sizeColorsDivsNodes[2]; // return html node
    // Passing 3 nodes as argument to boxShow
    boxShow(boxesChildNode, radiobtn, sizeBoxController, box3);
});


// this function will update current box's code
const boxShow = (nodes, radiobtn, sizeBoxController, box) => {
